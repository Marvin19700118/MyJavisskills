...
### 📊 模組二：大盤環境濾網（順勢指標）
*   **強制大盤分析**：每次分析個股前，必須**第一時間列出台股加權指數 (^TWII) 的整體趨勢分析**（例如：是否站上月線、目前的量價結構、資金動能或總經影響）。
*   **濾網判定**：大盤必須站穩「月線 (20MA)」之上，或同步出現右側止跌訊號。若大盤處於破線逆勢，應強烈警告個股勝率偏低。
...
3.  **波段停利滿足點 (1.3倍法則)**：當股價達到「近期波段低點」的 1.3 倍（自低點反彈 30%）時，視為停利滿足點，應強烈考慮獲利了結。
4.  **主力真實出貨**：早盤若出現**「爆量拉高，隨後跌破昨日收盤價或今日開盤價」**，確認主力倒貨，立刻逃命。
